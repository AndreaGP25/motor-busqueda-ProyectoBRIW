...
- **Relevancia ponderada** (títulos 3x más importantes)
- **Autocompletado** con sugerencias en tiempo real
- **Corrección ortográfica** ("¿Quizás quisiste decir?")
- **Búsqueda facetada** con filtros por dominio, año y contenido
...
# Apache Solr 9.10
# Descargar de: https://solr.apache.org/downloads.html
